...
var statusURL = "../../chromium-status.appspot.com/current@format=raw";
var statusHistoryURL =
  "../../chromium-status.appspot.com/allstatus@limit=20&format=json";
...
function fetchTryJobResults(fullPatchset, builder, buildnumber, completed) {
  var tryJobURL =
    "../../build.chromium.org/p/tryserver.chromium/json/builders/" +
